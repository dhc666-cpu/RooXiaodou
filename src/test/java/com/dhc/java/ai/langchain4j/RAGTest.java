...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("F:\\Java\\knowledge\\测试.txt");
        System.out.println(document.text());
    }

    // 加载单个文档
    //Document document = FileSystemDocumentLoader.loadDocument("F:\\Java\\测试.txt", new TextDocumentParser());
    // 从一个目录中加载所有文档
    //List<Document> documents = FileSystemDocumentLoader.loadDocuments("F:\\Java\\测试.txt", new TextDocumentParser());
    // 从一个目录中加载所有的.txt文档
    //PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.txt");
    //List<Document> documents = FileSystemDocumentLoader.loadDocuments("F:\\Java\\测试.txt", pathMatcher, new TextDocumentParser());
    // 从一个目录及其子目录中加载所有文档
    //List<Document> documents = FileSystemDocumentLoader.loadDocumentsRecursively("F:\\Java\\测试.txt", new TextDocumentParser());
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("F:\\Java\\knowledge\\人工智能.md");
